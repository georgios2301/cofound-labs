...
export const post: BlogPost = {
  ...
  title: "Was kostet eine Website? Preisübersicht 2026",
  metaTitle: "Was kostet eine Website? Preisübersicht 2026",
  metaDescription:
    "Was kostet eine Website 2026? Transparente Preisübersicht für Onepager, Unternehmensseiten und Websites mit Funktionen – inkl. laufender Kosten und worauf du achten solltest.",
  excerpt:
    "Von der schlanken Onepage ab 199 € bis zur mehrseitigen Unternehmensseite: Was eine Website kostet, hängt von wenigen klaren Faktoren ab. Hier ist die ehrliche Übersicht.",
  keyword: "was kostet eine website",
  category: "Kosten",
  date: "2026-06-05",
  ...
  faqs: [
    [
      ...
      "Bei Cofound Labs starten Websites ab 199 €. Eine schlanke Onepage ist günstiger als ein mehrseitiger Auftritt mit Buchungssystem oder Mehrsprachigkeit. Der genaue Preis hängt von Seitenzahl, Funktionen und Design ab – im kostenlosen Erstgespräch bekommst du eine transparente Einschätzung.",
    ],
    [
      "Warum kostet eine Website beim Anbieter mehr als ein Baukasten?",
      "Ein Baukasten ist günstig, aber du baust und pflegst alles selbst – und stößt schnell an Grenzen bei Design, Tempo und SEO. Eine individuell entwickelte Website ist auf dich zugeschnitten, schneller, sauber für Google aufgebaut und rechtssicher. Du zahlst für Zeit, Know-how und ein Ergebnis, das Anfragen bringt.",
    ],
    [
...
<p>Eine professionelle, individuell erstellte Website startet bei uns <strong>ab 199 €</strong>. Was am Ende dabei herauskommt, hängt vor allem von drei Dingen ab: Wie viele Seiten brauchst du, welche Funktionen sollen rein, und wie individuell soll das Design sein? Eine schlanke <strong>Onepage</strong> für einen lokalen Dienstleister ist ein anderes Projekt als eine mehrseitige Unternehmensseite mit Blog und Buchungssystem.</p>

<h2>Was den Preis bestimmt</h2>
<ul>
<li><strong>Seitenumfang:</strong> Eine einzelne, gut gemachte Seite (Onepage) ist günstiger als ein Auftritt mit Startseite, Leistungen, Über-uns, Kontakt und mehr.</li>
<li><strong>Funktionen:</strong> Kontaktformular und WhatsApp-Link sind Standard. Buchungssysteme, Mehrsprachigkeit, Mitgliederbereiche oder ein Shop erhöhen den Aufwand.</li>
<li><strong>Design:</strong> Ein individuelles Design, das zu deiner Marke passt, kostet mehr als ein Standard-Template – hebt dich aber sichtbar von der Konkurrenz ab.</li>
<li><strong>Inhalte:</strong> Liegen Texte und Bilder vor, geht es schneller. Wir unterstützen bei der Aufbereitung, wenn nötig.</li>
</ul>

<h2>Typische Pakete im Überblick</h2>
<ul>
<li><strong>Onepage (ab 199 €):</strong> Eine starke Seite mit allem Wichtigen – ideal für lokale Dienstleister, Handwerk und Selbstständige, die Anfragen wollen.</li>
