...
export const post: BlogPost = {
  ...
  faqs: [
    [
      "Was bedeutet „Website auffrischen“?",
      "Auffrischen heißt: Wir nehmen deine bestehende Website und gestalten sie komplett neu – modern, schnell und für das Handy optimiert. Deine Texte und Bilder übernehmen wir und bringen sie auf den aktuellen Stand. Du fängst also nicht bei null an, sondern baust auf dem auf, was schon da ist.",
    ],
    [
    ...
    [
      ...
      "Nein. Wir übernehmen Texte und Bilder von deiner alten Seite und frischen sie auf. Wenn du neue Fotos oder aktualisierte Inhalte hast, umso besser – nötig ist es aber nicht.",
    ],
    [
  ...
  body: `
<p>Deine Website steht seit Jahren unverändert online, sieht auf dem Handy komisch aus und bringt kaum noch Anfragen? Dann lohnt sich ein genauer Blick. „Auffrischen“ heißt: Wir nehmen deine bestehende Seite und machen sie komplett neu – modern, schnell und mobil – ohne dass du bei null anfängst. Hier klären wir, wann sich das lohnt, was es kostet und wie es abläuft.</p>

<h2>7 Anzeichen, dass deine Website veraltet ist</h2>
<ul>
<li><strong>Auf dem Handy unbrauchbar:</strong> Du musst zoomen und schieben, Buttons sind zu klein. Dabei kommen die meisten Besucher heute vom Smartphone.</li>
<li><strong>Langsam:</strong> Die Seite braucht spürbar länger als zwei, drei Sekunden zum Laden.</li>
<li><strong>Design von gestern:</strong> Kleine Schriften, viele Kästchen, blasse Stockfotos – der Auftritt wirkt wie 2010.</li>
<li><strong>Keine Anfragen:</strong> Es gibt keinen klaren Weg, dich zu kontaktieren – kein sichtbarer Button, keine WhatsApp-Option.</li>
<li><strong>Veraltete Inhalte:</strong> Alte Öffnungszeiten, Preise oder Angebote, die niemand mehr pflegt.</li>
<li><strong>Nicht bei Google zu finden:</strong> Wer deinen Namen nicht schon kennt, findet dich nicht.</li>
<li><strong>Kein Impressum, kein Datenschutz:</strong> Rechtlich ein Risiko – und im Zweifel teuer.</li>
</ul>
<p>Trifft davon mehr als eines zu, ist ein Relaunch überfällig.</p>

<h2>Auffrischen oder neu bauen – was ist der Unterschied?</h2>
